    ...
    return (
      <div class="container-fluid page__container">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Interactive pervasive computing</li>
        </ol>
        <h1 class="h2">Interactive pervasive computing</h1>
        <div class="row">
          <div class="col-md-8">
            <div class="card">
        ...
        <div class="container ringgg">
          ...
          <div class="ed_view_features pl-4">
            ...
            <ul class="mt-2">
              <li>
                <i class="ti-time"></i>
                <strong>11 weeks</strong> long
              </li>
              <li>
                <i class="ti-files"></i>
                <strong>34</strong> Lessons
              </li>
              <li>
                <i class="ti-book"></i>
                <strong>10 hours</strong> weekly study
              </li>
              <li>
                <i class="ti-shine"></i>
                <strong>Progressive Assessments</strong>
              </li>
            </ul>
          </div>
        </div>
